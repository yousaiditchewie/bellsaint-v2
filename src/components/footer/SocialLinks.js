...
import tiktokIcon from '../../img/social/TikTok_Icon_Black_Circle.png';
  ...
  render() {
    return (
      <div className="SocialLinks">
        ...
        <a
          className="SocialLinks-link SocialLinks-link--tiktok"
          href="https://www.tiktok.com/@bellsaintmusic"
          target="_blank"
          title="TikTok"
          name="TikTok"
          rel="noopener"
        >
          <img src={tiktokIcon} alt="TikTok Logo" className="SocialLinks-link--tiktokIcon" />
        </a>
      </div>
    );
  }
